...
|-------------------------------|---------------------|------:|
|Stage I: Proposal			        |	Fri May 1 	        | 5     |
|Stage II:	Peer Review				  | Tues May 12		      | 5     |
|Stage III: Project Submission	|	Fri May 15  		    | 80    |
|Stage IV: Project Presentation	|	Fri May 15	        | 10    |
|**Total**									    |                     |**100**|
...
> You *MAY* use the same data scraped for Mini-Project 2. If you don't think there's enough there to turn into a robust project, consider aquiring more data or totally switching gears into something else.
...
- Table of variables you plan to acquire, including variables you plan to generate from your raw data
