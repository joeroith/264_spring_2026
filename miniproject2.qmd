...
|--------------|----------------------|--------------------|--------|
| **Stage I**  | Project Proposal     | Fri, Mar 27        | 10     |
| **Stage II** | GitHub Collaboration | Thurs, Apr 9       | 10     |
| **Stage III**| Project Submission   | Friday, Apr 17     | 80     |
|              |                      |                    | 100    |
...
You will submit a link to a GitHub repo that contains:

$\Box$ a quarto file with your code, and 
$\Box$ at least one .csv file (formed using `write_csv()`) containing data you have acquired and then cleaned.  
...
Mini-Project 2 must be submitted on Moodle by **11:00 PM on Fri, Apr 17**. You should submit a rendered pdf.
