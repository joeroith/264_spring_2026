...
You can download this .qmd file from [here](https://github.com/joeroith/264_spring_2026/blob/main/SQL_code/15_SQL_exercises.qmd).  Just hit the Download Raw File button. 

The code in [15_SQL.qmd](https://github.com/joeroith/264_spring_2026/blob/main/SQL_code/14_SQL.qmd) walked us through many of the examples in MDSR Chapter 15; now, we present a set of practice exercises in converting from the tidyverse to SQL. You may also find both these files on the [St. Olaf RStudio server](https://r.stolaf.edu) in our class folder under Code.
