...
Ideally before class on Thurs Feb 5, and definitely before class on Tues Feb 10, you should follow these instructions to set up the software that we'll be using throughout the semester. **Even if you've already downloaded both R and RStudio, you'll want to re-download to make sure that you have the most current versions.**
...
- **FIRST:** Download R [here](https://cran.rstudio.com/).
    ...
    - As of the start of this semester, the latest version of R is 4.5.2 (“[Not] Part in a Rumble”).
- **SECOND:** Download RStudio [here](https://posit.co/download/rstudio-desktop/#download).
    ...
    - As of the start of this semester, the latest version of RStudio is 2026.01.0 (Build 392).
